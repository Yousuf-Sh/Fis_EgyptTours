		...
		<div class="hero overlay innerPage">
			...
			<div class="container inner2pages-container">
				<div class="row align-items-center justify-content-center rowPadding py-2">
					<div class="col-lg-12">
						<h1 class="heading" data-aos="fade-up">@lang('message.faqs')</h1>
		...
		<div class="container">
			<div class="row justify-content-between align-items-center">
				<!-- <div class="col-lg-5 mb-4 mb-lg-0">
					<img src="images/img_v_2.jpg" alt="Image" class="img-fluid brdrRds">
				</div> -->
				<div class="col-lg-12 mt-0 mt-sm-3  mt-lg-0"  data-aos="fade-up" data-aos-delay="100">

					<!-- <h2 class="heading mb-5">Frequently Asked <br> Questions</h2> -->
					<h2 class="heading mb-5">@lang('message.faqs')</h2>

					<div class="custom-accordion" id="accordion_1">
						<div class="accordion-item">
							<h2 class="mb-0">
								<button class="btn btn-link" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
									@lang('message.faqs1q') </button>
							</h2>
