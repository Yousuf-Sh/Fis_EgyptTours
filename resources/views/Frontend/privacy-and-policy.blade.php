		...
		<div class="hero overlay innerPage">
			...
			<div class="container inner2pages-container">
				<div class="row align-items-center justify-content-center rowPadding py-2">
					<div class="col-lg-12">
						<h1 class="heading" data-aos="fade-up">@lang('message.PrivacyPolicy')</h1>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="terms-body">
                    <h4><strong>@lang('message.privacy_main_line')</strong></h4>    
                    <hr>
                    <h3>@lang('message.privacy_title1')</h3>
                    <p>
                    @lang('message.privacy_para1')
                    </p>
                    <hr>
                    <h3>@lang('message.privacy_title2')</h3>
                    <p>@lang('message.privacy_para2')
                    </p>
					<ul>
						<li>@lang('message.privacy_para2_li1')</li>
						<li>@lang('message.privacy_para2_li2')</li>
						<li>@lang('message.privacy_para2_li3')</li>
						<li>@lang('message.privacy_para2_li4')</li>
						<li>@lang('message.privacy_para2_li5')</li>
					</ul>
                    <hr>
                    <h3>@lang('message.privacy_title3')</h3>
                    <p>@lang('message.privacy_para3')
                    </p>
					<ul>
						<li>@lang('message.privacy_para3_li1')</li>
						<li>@lang('message.privacy_para3_li3')</li>
						<li>@lang('message.privacy_para3_li3')</li>
						<li>@lang('message.privacy_para3_li4')</li>
					</ul>
                    <hr>
                    <h3>@lang('message.privacy_title4')</h3>
                    <p>@lang('message.privacy_para4')</p>
                
                    <hr>
                    <h3>@lang('message.privacy_title5')</h3>
                    <p>@lang('message.privacy_para5')</p>
					<ul>
						<li>@lang('message.privacy_para5_li1')</li>
						<li>@lang('message.privacy_para5_li2')</li>
						<li>@lang('message.privacy_para5_li3')</li>
					</ul>
                    <hr>
                    <h3>@lang('message.privacy_title6')</h3>
                    <p>
					@lang('message.privacy_para6')
                    </p>
                    <hr>
                    <h3>@lang('message.privacy_title7')</h3>
                    <p>@lang('message.privacy_para7')
                    </p>
                    <hr>
                    <h3>@lang('message.privacy_title8')</h3>
                    <p>@lang('message.privacy_para8')</p>
                    <hr>
                    <h3>@lang('message.privacy_title8')</h3>
                    <p >@lang('message.privacy_para9')
                    </p>      
