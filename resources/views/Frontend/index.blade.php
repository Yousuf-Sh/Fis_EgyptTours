...
@section('content')	
	...
	<div class="hero overlay videoCont">
		...
		<!-- <div class="img-bg rellax"> -->
			@if(str_contains($slider->media_path, 'video'))
			<video autoplay muted loop playsinline class="bg-video">
				<source src="{{asset($slider->media_path)}}" type="video/mp4">
				Your browser does not support the video tag.
			</video>
			@else
			<img src="{{asset($slider->media_path)}}" alt="slider-banner">
			@endif
		<!-- </div> -->
		...
		<div class="container index-container">
			<div class="row align-items-center justify-content-start">
				<div class="col-lg-5 text-center-sm-c">
					...
					<h1 class="heading" data-aos="fade-up">{{$slider->title}}</h1>
					{!! str_replace('<p>', '<p class="mb-md-5" data-aos="fade-up">', $slider->description) !!}
					...
					<div data-aos="fade-up">
						<a href="{{route('about')}}" class="bnr-btn align-items-center d-flex " >
							<span class="caption btn btn-primary">{{$slider->button_text}}</span>
						</a>
					</div>
			...
			<div class="row align-items-center justify-content-between">
				...
				<div class="col-xl-4 col-lg-6 order-lg-1 col-lg-4 col-md-6">
					<div>
						...
						<p class="my-md-4 my-1" data-aos="fade-up" data-aos-delay="300"><a href="{{url('about')}}" class="btn btn-primary">{{ $cmsData['explore-more']->tagline2}}</a></p>
					</div>
				</div>
		...
		<div class="container">
			<div class="row justify-content-between align-items-center">
				<div class="col-lg-5 mb-4 mb-lg-0 order-lg-2" data-aos="fade-up">
					<img src="{{asset($cmsData['memories']->image1)}}" alt="Image" class="img-fluid brdrRds boxShadow sweetMemImg">
				</div>
				<div class="col-lg-5" data-aos="fade-up" data-aos-delay="100">
					<h2 class="heading mb-4">{{$cmsData['memories']->title}}</h2>
					<!-- <p>@lang('message.sweet_memories_para1')</p> -->
					<p>{{$cmsData['memories']->short_description}}</p>
					<p class="my-4" data-aos="fade-up" data-aos-delay="200"><a href="{{url('excursions')}}" class="btn btn-primary readmoreBtn">{{$cmsData['memories']->title1}}</a></p>
				</div>	
			</div>
		</div>
	</div>
			...
			<div class="row justify-content-between align-items-center">
				...
				<div class="col-lg-6">
					<figure class="img-play-video">
						<a id="play-video" class="video-play-button  glightbox3" href="{{$cmsData['tour-video']->title2}}" >
							<span></span>
						</a>
						<img src="{{asset($cmsData['tour-video']->image1)}}" alt="Image" class="img-fluid brdrRds boxShadow sweetMemImg">
					</figure>
				</div>

				<div class="col-lg-5">
					<h2 class="heading mb-4">{{$cmsData['tour-video']->title}}</h2>
					...
					{!!$cmsData['tour-video']->short_description	!!}
					<p><a href="{{route('excursions')}}" class="btn btn-primary getStartedBtn">{{$cmsData['tour-video']->title1}}</a></p>
		...
		<div class="container">
			<div class="row justify-content-between align-items-center">
				<div class="col-12 col-xl-6 col-lg-6 mb-4 mb-lg-0">
					<img src="{{asset($cmsData['faq']->image1)}}" alt="Image" class="img-fluid brdrRds boxShadow exploreImg">
				</div>
				<div class="col-12 col-xl-5 col-lg-6 mt-4 mt-lg-0"  data-aos="fade-up" data-aos-delay="100">
					...
					<h2 class="heading mb-md-5">{{$cmsData['faq']->title}}</h2>
					...
					<div class="custom-accordion" id="accordion_1">
						@foreach($faqs as $index => $faq)
							<div class="accordion-item">
								...
								<div id="collapse{{ $index }}" class="collapse" aria-labelledby="heading{{ $index }}" data-bs-parent="#accordion_1">
				...
				@foreach($testimonials as $testimonial)
					<div class="item">
						<blockquote class="block-testimonial">
							<div class="author">
								<img src="{{asset($testimonial->image)}}" alt="Free template by TemplateUX">
								<h3>{{$testimonial->name}}</h3>
								<p class="position mb-5"></p>
							</div>
							<p>
								<div class="quote">&ldquo;</div>
							&ldquo;{{$testimonial->review}}&rdquo;</p>
						</blockquote>
					</div>
				@endforeach
<!--
