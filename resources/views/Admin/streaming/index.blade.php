  ...
  <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Manage Streaming</li>
        </ol>
      </nav>
    </div>
              ...
              <table class="table table1" id="example">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex">
                        <a href="{{route('streaming.edit',$record->id)}}" title="click to Edit" class="text-info"><span class="fa fa-pencil"></span></a>&nbsp;
                        <a href="{{route('streaming.delete',$record->id)}}" title="click to Delete" class="text-danger"><span class="fa fa-trash"></span></a>
                      </div>
                    </td>
                  </tr>
                  @endforeach
