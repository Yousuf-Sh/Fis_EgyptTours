            ...
            <div class="card-body">
              ...
              <form class="row g-3"  method="POST" action="{{route('project.store')}}" enctype="multipart/form-data">
                ...
                {{-- <div class="col-md-6">
                  ...
                  <input type="text" name="label" class="form-control" id="inputtitle" placeholder="">
                </div>  --}}
                <div class="col-md-6">

                  <label for="inputState" class="form-label">Description</label>
                  <textarea type="text" class="form-control" id="inputName5" rows="3" name="short_description"></textarea>
                </div>
                {{-- <div class="col-md-6">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" name="arabic_title" class="form-control" id="inputtitle" style="direction:rtl;" placeholder="">
                </div>
                {{-- <div class="col-md-6">
                  <label for="inputtitle" class="form-label">Label</label>
                  <input type="text" name="label" class="form-control" id="inputtitle" placeholder="">
                ...
                <div class="col-md-6">
                  ...
                  <label for="inputState" class="form-label">وصف</label>
                  <textarea type="text" class="form-control" id="inputName5" rows="3" style="direction:rtl;" name="arabic_description"></textarea>
                </div>
                {{-- <div class="col-md-6">
                  <label for="inputState" class="form-label">Button</label>
                  <input type="text" name="button" class="form-control" id="inputtitle" placeholder="">
                ...
                {{-- <div class="col-md-6">
                  <label for="inputState" class="form-label">صورة</label>
                  <input type="file" name="arabic_image" id="imgInp" required="" accept="image/*" class="form-control input-default " placeholder="Select image" onchange="loadFile1(event)" >
