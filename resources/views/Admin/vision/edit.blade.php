    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Edit choosing</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form class="row g-3"  method="POST" action="{{route('vision.update')}}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{$vision->id}}"/>
                <div class="col-md-6">
                  <label for="inputtitle" class="form-label">Title</label>
                  <input type="text" name="title" class="form-control" id="inputtitle" placeholder="" value="{{$vision->title}}">
                </div> 
                <div class="col-md-6">
                  <label for="inputtitle" class="form-label">Logo</label>
                  <input type="text" name="logo" class="form-control" id="inputtitle" placeholder="" value="{{$vision->logo}}">
                </div>
                <div class="col-md-12">
                  <label for="inputState" class="form-label ckeditor">Short Description</label>
                  <textarea type="text" class="form-control" id="inputName5" rows="3" name="short_description">{{$vision->description}}</textarea>
                </div>
                <!-- <div class="col-md-6">
                  <label for="inputtitle" class="form-label">Label</label>
                  <input type="text" name="label" class="form-control" id="inputtitle" placeholder="" value="{{$vision->label}}" >
                </div>  -->
                {{-- <div class="col-md-6">
                ...
                {{-- <div class="col-md-6">
                    ...
                    <a href=""  ><img src="{{ asset('Backend/images/' . $vision->images) }}" id="output"  width="150" ></a>
                </div> --}}
            ...
            <div class="tab-pane fade" id="arabic" role="tabpanel" aria-labelledby="arabic-tab">
             ...
             <div class="row">
                ...
                <div class="col-md-6">
                  <label for="inputtitle" class="form-label">Title</label>
                  <input type="text" name="arabic_title" class="form-control" id="inputtitle" style="direction:rtl;"placeholder="" value="{{$vision->arabic_title}}">
                </div> 
                <div class="col-md-6">
                  <label for="inputtitle" class="form-label">Logo</label>
                  <input type="text" name="arabic_logo" class="form-control" id="inputtitle" placeholder="" value="{{$vision->arabic_logo}}">
                </div>
                <div class="col-md-12">
                  <label for="inputState" class="form-label">Short Description</label>
                  <textarea type="text" class="form-control ckeditor" id="inputName5" rows="3" style="direction:rtl;"name="arabic_short_description">{{$vision->arabic_short_description}}</textarea>
                </div>
                <!-- <div class="col-md-6">
                  <label for="inputtitle" class="form-label">Label</label>
                  <input type="text" name="label" class="form-control" id="inputtitle" placeholder="" value="{{$vision->label}}" >
                ...
                {{-- <div class="col-md-6">
                    ...
                    <a href=""  ><img src="{{ asset('Backend/images/' . $vision->arabic_image) }}" id="output1"  width="150" ></a>
                </div> --}}
