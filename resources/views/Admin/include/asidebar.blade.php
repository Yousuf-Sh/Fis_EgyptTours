...
<aside id="sidebar" class="sidebar">
   <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
         <a class="nav-link  {{request()->segment(2) == 'slider'|| request()->segment(2) == 'explore'|| request()->segment(2) == 'about-services'|| request()->segment(2) == 'memories'|| request()->segment(2) == 'video' || request()->segment(2) == 'faq' || request()->segment(2) == 'testimonial' || request()->segment(2) == 'blogs' )? '' : 'collapsed'}}" data-bs-toggle="collapse" data-bs-target="#setting-nav" aria-expanded="false" aria-controls="collapse">
         <i class="bi bi-collection-fill"></i><span>Home Mangement</span><i class="bi bi-chevron-down ms-auto"></i>
         </a>
         <ul id="setting-nav" class="nav-content  {{ (request()->segment(2) == 'management')? ' show' : ''}}" data-bs-parent="#sidebar-nav" >
