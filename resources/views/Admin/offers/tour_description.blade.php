    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Add Tour Description</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
                        ...
                        <div class="tab-content" id="languageTabsContent">
                            @foreach($languages as $index => $language)
                                <div class="tab-pane fade {{ $index === 0 ? 'show active' : '' }}" 
                                    ...
                                    <div class="card mt-3">
                                        <div class="card-header">Tours Descriptions</div>
                                        <div class="card-body">
                                        <form action="{{ route('update.tour_description')}}" method="POST">
                                            @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input name="{{ $language->slug }}_title_ex" class="form-control" id="title" {{ $language->slug === 'ar' ? 'style=direction:rtl;' : '' }} value="{{ $offersByLanguage[$language->slug]->title_ex ?? '' }}">
                                                </div>
                                                <div class="col-md-12 mt-2">
                                                    <label for="description2" class="form-label">Description</label>
                                                    <textarea type="text" class="form-control ckeditor" id="inputName5" name="{{ $language->slug }}_description_ex">{{ $offersByLanguage[$language->slug]->description_ex ?? '' }}</textarea>
                                                </div>
