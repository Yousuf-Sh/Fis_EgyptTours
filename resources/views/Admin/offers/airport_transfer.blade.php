    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Add Airport Transfer</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3 my-3 submit-form" method="POST" action="{{ route('offers.store') }}" enctype="multipart/form-data" id="packageForm">
                        @csrf
                     ...
                     <div class="col-md-6 mt-2">
                                    ...
                                    <div class="col-md-6 mt-2">
                                        ...
                                        <select name="packages[${packageCount}][destination]" class="form-select">
                                            ...
                                            <option value="Awsīm">Awsīm</option>
