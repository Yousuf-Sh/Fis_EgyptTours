      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <form class="row g-3 my-3" method="POST" action="{{ route('languages.store') }}" enctype="multipart/form-data">
                          @csrf
                          <div class="col-md-6">
                          ...
                          <!-- <div class="col-md-6">
                              ...
                              title="Short Form of Language name.Example: Slug for Englis is en"
                              placeholder="Example: For english, en"
                               required>
                          </div> -->
                        <div class="col-md-6">
